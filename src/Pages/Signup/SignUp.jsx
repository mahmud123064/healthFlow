                                ...
                                <div className="border-solid border-2 border-white rounded-lg p-12 mb-2">
                                    ...
                                    <form>
                                        <div className="mb-5 " onClick={handleImageClick}>
                                            ...
                                            <div className="relative overflow-hidden w-24 rounded-full mx-auto mb-3 border-solid border-2 border-white">
                                                <img src={image} alt="profile image" className=" " />

                                                <input type="file" name="" id="" ref={inputRef} onChange={handleImageChange} className="mb-3 " style={{ display: "none" }} />
